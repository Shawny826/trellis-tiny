 ...
 *
 * trellis-implement and trellis-check use hook-based context injection
 * (PreToolUse `Agent|Task` mutation) with in-template fallbacks.
 * trellis-research is intentionally standalone: it does not receive the
 * implement/check injection, and persists findings under the active task's
 ...
 *
 * Ported from upstream `packages/cli/src/templates/zcode/index.ts`.
 */
