...
export function homedirGuardMessage(
  commandName: "init" | "uninstall",
): string {
  return (
    `✗ Refusing to run \`tt ${commandName}\` in your home directory.\n\n` +
    `trellis-tiny manages platform config dirs like .zcode/, .codex/, .dsh/, which\n` +
    ...
    `Run trellis-tiny from your project directory instead. If you really want to run in\n` +
